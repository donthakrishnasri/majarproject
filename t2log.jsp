    ...
    <header>
       <div class="header-content">
			...
			<form action="t2log1.jsp" method="post"><center>
				...
				<td><input type="text" required name="name" pattern="[a-zA-Z0-9]+"  required maxlength="10" placeholder="enter user name" style="margin-right: 10px;margin-top: 25px;margin-left: 10px;margin-bottom: 10px;color: #31708f;"></td></tr></div>
